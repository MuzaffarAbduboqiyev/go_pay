...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.factory<_i17.MonitoringNetworkService>(
        () => _i17.MonitoringNetworkService(gh<_i6.NetworkService>()));
    gh.factory<_i18.MonitoringRepository>(
        () => _i18.MonitoringRepository(gh<_i17.MonitoringNetworkService>()));
    gh.factory<_i19.OtpRepository>(() => _i19.OtpRepository(
          gh<_i11.AuthNetworkService>(),
          gh<_i5.SharedPreferencesRepository>(),
        ));
    return this;
